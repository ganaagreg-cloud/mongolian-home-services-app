...
export function ReviewScreen({ onSubmit, onHome, onRebook }: ReviewScreenProps) {
      ...
      <div className="flex min-h-screen flex-col items-center justify-center bg-background px-6">
        ...
        <div className="mt-8 flex w-full gap-3">
          <Button
            onClick={onRebook}
            variant="outline"
            className="h-14 flex-1 rounded-2xl border-border bg-card font-semibold shadow-sm"
          >
          ...
          <Button
            onClick={onHome}
            className="h-14 flex-1 rounded-2xl bg-primary font-semibold shadow-md"
          >
