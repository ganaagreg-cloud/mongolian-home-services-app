    ...
    <div className="flex min-h-screen flex-col bg-background pb-24">
      ...
      <div className="mx-6 mt-4">
        <div className="mb-2 flex items-center justify-between">
          <h2 className="font-semibold text-foreground">Мэргэжил ба үнэ</h2>
          {!isEditingProfile && (
            <button
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <p className="font-semibold text-primary">
                  {workerData?.pricePerHour ? `₮${workerData.pricePerHour.toLocaleString()}` : '—'}
                </p>
          ...
          <div className="space-y-4">
            <div className="space-y-4 rounded-2xl bg-card p-4 shadow-sm">
              ...
              <div>
                ...
                />
                {editPrice && !editPriceValid && (
                  <p className="mt-1 text-xs text-destructive">₮1,000–₮500,000 хооронд байх ёстой</p>
                )}
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <Button
                ...
                disabled={!editProfileValid || profileSaving}
