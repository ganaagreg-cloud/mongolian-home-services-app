...
// For use in Server Components (layout.tsx, page.tsx) — reads BA session via request headers.
export async function getServerSession(): Promise<(SessionPayload & { name: string }) | null> {
